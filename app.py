...
(df_etf_init, df_orders_init, df_dividends, df_income_init, df_prices_init, \
    df_cashflow_init, _, df_crypto_trades_init) = pl.load_data()
...
df_crypto_trades_init = pl.preprocess_crypto_data(df_crypto_trades_init)
portfolio_crypto = pl.compute_crypto_portfolio(df_crypto_trades_init)
