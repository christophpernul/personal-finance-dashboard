...
# default_style_text_centered = default_style_text.copy().update({'text-align': 'center'})
...
body = html.Div([header_panel,
                 dataframe_panel,
                 chart_panel
                ]
        )

app.layout = html.Div([body], style=default_style_text)
# app.layout = \
#     dbc.Card(
#         dbc.CardBody(
#             dpl.show_dataframe(portfolio_view, style_dict=colors)
